...
export default function TokenLogin() {
  return (
    <div className="min-h-screen bg-sky-950 flex flex-col justify-center items-center p-6 relative overflow-hidden">
      {/* Background Effects */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-800/30 via-sky-950 to-sky-950 pointer-events-none"></div>
      <div className="absolute -top-24 -left-24 w-[500px] h-[500px] bg-sky-400/10 rounded-full blur-[120px] pointer-events-none"></div>
