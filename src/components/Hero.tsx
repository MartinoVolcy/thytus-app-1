                ...
                <div className="flex items-center justify-between mb-6 px-4 py-2 border-b border-white/5">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex -space-x-2.5">
                      <Image alt="Avatar" className="rounded-full border-2 border-[#0a0c16]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAV3HOmX_CPPbwdM4Yp9MjiBE3U5pJd9JoRianeOsOrybeSIKlh_iV2Wig1hjxqbsTiKHtBYuLvYmV3-JfuTya2rhGu4zsk9-t5xXo9WGxweh1mowTjqMiZf_HIXnCEL0rig_pLfpstHk37n1BMje7_JFsd-hE6t-JfuOz5N5Y2LyUoND-xZhMhgyklSSQXTeWzcl2BVR1eLfRBuY_anJq4TNMV_H5wCDzY2Ir9sDSZQt9Tr8UPemVjgAAvcBuXYb-l-m8GrgK-baw" width={32} height={32} />
                      <Image alt="Avatar" className="rounded-full border-2 border-[#0a0c16]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAIydP2pPD91kyFAeq9tNGfASpN9Wr8hSGdUEBnu_lUET0Lm-hmEbW5Rhwd_OUzIh5tQP2POYqOwQ0Tr_WeOdw1sJV8mcWlNrNYnk7s22CZHmTU0JGV36HZqhUB-z0wt7LJUmNG013skuEUJ_y8cMkFpUGXwHt117Bl1hj2By6bAS3q6nin5dHqAIMu9q-0y397T-IPewJja9KClmGcSe3LXL4H5hYKS5G1-8WlSAH3EHMdobL84RnIHcjwfdZQob7V8aaKAWFTFp4" width={32} height={32} />
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-white/5 border border-white/5 rounded-xl space-y-3">
                        ...
                        <div className="flex items-center gap-2 pt-2">
                          <Image alt="Avatar" className="rounded-full" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDqD0cxex0YGTQWW3WqcscIhK8B0HRZWH9qv5f5ZFUNa2e2jBWCDCI4MHBSmMDDdBOJgFUIgsuaUd5BXkcoFxJHotJ2PShkWZE7T3_EAM8PUCD7J8-zI4YeMXWmT_NSrQyBQ5_xHZYjlB9XeJKFj9YuWkdGvM22iZuZsZAaACMgjxTEmsyO3s8_tppzCqIXUV4eXxoPCtaz4M14HUEhm2VrNTRvKQU3MjengZHRVn475WRRUxJJga-7TrCA-VyzokEBgdnSI2c_zGY" width={24} height={24} />
