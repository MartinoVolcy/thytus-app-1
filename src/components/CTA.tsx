  ...
  return (
    <section className="py-24 relative bg-slate-900 overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <h2 className="text-4xl md:text-6xl font-medium mb-6 text-white font-display">
        ...
        <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          tab, with separate context. Thytus unifies them. Bring every human and
          every AI agent into one shared workspace so knowledge is never lost or
          misunderstood.
        </p>
